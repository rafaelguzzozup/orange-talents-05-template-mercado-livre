...
@Component
public class CompraProcessadaSemSucessoEnviaEmailListener implements ApplicationListener<CompraProcessadaComSucesso> {
	...
	public void onApplicationEvent(CompraProcessadaComSucesso event) {
		emails.vendaSucessoComprador(event.getCompra());
	}
